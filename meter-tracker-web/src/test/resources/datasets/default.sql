...
-- Set next value of sequences to 100 in order to not get autogenerated ids equal to manually added values
ALTER SEQUENCE image_info_id_seq RESTART WITH 100;
ALTER SEQUENCE indication_id_seq RESTART WITH 100;
